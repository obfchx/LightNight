...
function TP(Pos)
	...
	game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / TweenSpeed, Enum.EasingStyle.Linear), {CFrame=Pos}):Play();
end
function TP1(Pos)
	Distance = (Pos.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude;
	game:GetService("TweenService"):Create(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / TweenSpeed, Enum.EasingStyle.Linear), {CFrame=Pos}):Play();
end
local stoppos = {};
function topos(Pos)
	local Distance = (Pos.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude;
	local tween = game:GetService("TweenService"):Create(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / TweenSpeed, Enum.EasingStyle.Linear), {CFrame=Pos}):Play();
	stoppos.Stop = function(self)
		tween:Cancel();
	end;
	return stoppos;
end
...
function AttackNoCD()
	if (not _G.AutoFarmFruitMastery or not _G.AutoFarmGunMastery) then
		if _G.FastAttack then
			...
			for h = 1, 1 do
				local V = require(game.ReplicatedStorage.CombatFramework.RigLib).getBladeHits(PBlade.Character, {PBlade.Character.HumanoidRootPart}, 60);
				local W = {};
				local X = {};
...
local AttackList = {0,0.1,0.15,0.165,0.175,0.2,0.25};
		...
		if (_G.Autotushita and World3) then
			pcall(function()
				...
				if (ripIndraSpawn and longmaSpawn) then
					topos(CFrame.new(5154.85303, 141.812225, 913.080933, 0.138356507, 5.1763767e-8, 0.990382493, 4.594968e-8, 1, -5.8685615e-8, -0.990382493, 5.3627293e-8, 0.138356507));
					if ((CFrame.new(5154.85303, 141.812225, 913.080933, 0.138356507, 5.1763767e-8, 0.990382493, 4.594968e-8, 1, -5.8685615e-8, -0.990382493, 5.3627293e-8, 0.138356507).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Position).Magnitude < 2) then
						wait(2);
						Torch = true;
					end
				end
...
Sea:Seperator("Sea");
local ListSeaBoat = {"Guardian","PirateGrandBrigade","MarineGrandBrigade","PirateBrigade","MarineBrigade","PirateSloop","MarineSloop","BeastHunter"};
local ListSeaZone = {"Zone 1","Zone 2","Zone 3","Zone 4","Zone 5","Zone 6","Infinite"};
	...
	pcall(function()
		while wait() do
			...
			elseif (_G.SelectedZone == "Infinite") then
				CFrameSelectedZone = CFrame.new(-148073.359, 8.99999523, 7721.05078, -0.0825930536, -0.0000015441615, 0.996583343, -0.000018696026, 1, -3.918581e-13, -0.996583343, -0.000018632149, -0.0825930536);
			end
		end
	end);
end);
	...
	pcall(function()
		game:GetService("RunService").RenderStepped:connect(function()
			if (AimSkillNearest and (TargetPlayerAim ~= nil) and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").Name]:FindFirstChild("MousePos")) then
				local args = {[1]=game:GetService("Players"):FindFirstChild(TargetPlayerAim).Character.HumanoidRootPart.Position};
	...
	pcall(function()
		while task.wait() do
			if (_G.Aimbot_Skill and (PlayerSelectAimbot ~= nil) and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").Name]:FindFirstChild("MousePos")) then
				local args = {[1]=game:GetService("Players"):FindFirstChild(PlayerSelectAimbot).Character.HumanoidRootPart.Position};
...
T:Seperator("Island");
if World1 then
	T:Dropdown("Select Island", {"WindMill","Marine","Middle Town","Jungle","Pirate Village","Desert","Snow Island","MarineFord","Colosseum","Sky Island 1","Sky Island 2","Sky Island 3","Prison","Magma Village","Under Water Island","Fountain City","Shank Room","Mob Island"}, false, function(value)
		_G.SelectIsland = value;
	end);
end
if World2 then
	T:Dropdown("Select Island", {"The Cafe","Frist Spot","Dark Area","Flamingo Mansion","Flamingo Room","Green Zone","Factory","Colossuim","Zombie Island","Two Snow Mountain","Punk Hazard","Cursed Ship","Ice Castle","Forgotten Island","Ussop Island","Mini Sky Island"}, false, function(value)
		_G.SelectIsland = value;
	end);
end
if World3 then
	T:Dropdown("Select Island", {"Mansion","Port Town","Great Tree","Castle On The Sea","MiniSky","Hydra Island","Floating Turtle","Haunted Castle","Ice Cream Island","Peanut Island","Cake Island","Cocoa Island","Candy Island","Tiki Outpost"}, false, function(value)
		_G.SelectIsland = value;
	end);
end
	...
	if (_G.TeleportIsland == true) then
		repeat
			...
			elseif (_G.SelectIsland == "Tiki Outpost") then
				topos(CFrame.new(-16218.6826, 9.08636189, 445.618408, -0.0610186495, 1.1051259e-9, -0.99813664, -1.8345848e-8, 1, 2.2287177e-9, 0.99813664, 1.8447656e-8, -0.0610186495));
			end
...
T:Seperator("Npc");
if World1 then
	T:Dropdown("Select NPC", {"Random Devil Fruit","Blox Fruits Dealer","Remove Devil Fruit","Ability Teacher","Dark Step","Electro","Fishman Karate"}, false, function(value)
		_G.SelectNPC = value;
	end);
end
if World2 then
	T:Dropdown("Select NPC", {"Dargon Berath","Mtsterious Man","Mysterious Scientist","Awakening Expert","Nerd","Bar Manager","Blox Fruits Dealer","Trevor","Enhancement Editor","Pirate Recruiter","Marines Recruiter","Chemist","Cyborg","Ghoul Mark","Guashiem","El Admin","El Rodolfo","Arowe"}, false, function(value)
		_G.SelectNPC = value;
	end);
end
if World3 then
	T:Dropdown("Select NPC", {"Blox Fruits Dealer","Remove Devil Fruit","Horned Man","Hungey Man","Previous Hero","Butler","Lunoven","Trevor","Elite Hunter","Player Hunter","Uzoth"}, false, function(value)
		_G.SelectNPC = value;
	end);
end
...
local RarityFruits = {Common={"Rocket Fruit","Spin Fruit","Chop Fruit","Spring Fruit","Bomb Fruit","Smoke Fruit","Spike Fruit"},Uncommon={"Flame Fruit","Falcon Fruit","Ice Fruit","Sand Fruit","Diamond Fruit","Dark Fruit"},Rare={"Light Fruit","Rubber Fruit","Barrier Fruit","Ghost Fruit","Magma Fruit"},Legendary={"Quake Fruit","Budha Fruit","Love Fruit","Spider Fruit","Sound Fruit","Phoenix Fruit","Portal Fruit","Rumble Fruit","Pain Fruit","Blizzard Fruit"},Mythical={"Gravity Fruit","Mammoth Fruit","T-Rex Fruit","Dough Fruit","Shadow Fruit","Venom Fruit","Control Fruit","Spirit Fruit","Dragon Fruit","Leopard Fruit","Kitsune Fruit"}};
